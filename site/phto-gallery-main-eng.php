...
<ul id="sd-nav">
  ...
  <li><a href="#">Aswan</a>
    ...
    <div id="gallery" class="three_quarter">
        <section>
        <figure>
          <h2 class="H1-shadow center">Page Title</h2>
          <br/>
          <ul class="clear center">
            <li class="one_third first"><a href="phto-gallery-intrnl-eng.php"><img src="assets/images/demo/gallery.gif" alt=""></a>
            <br/><a href="phto-gallery-intrnl-eng.php">text text text</a>
            </li>
            <li class="one_third"><a href="phto-gallery-intrnl-eng.php"><img src="assets/images/demo/gallery.gif" alt=""></a>
            <br/><a href="phto-gallery-intrnl-eng.php">text text text</a>
            </li>
            <li class="one_third"><a href="phto-gallery-intrnl-eng.php"><img src="assets/images/demo/gallery.gif" alt=""></a>
            <br/><a href="phto-gallery-intrnl-eng.php">text text text</a>
