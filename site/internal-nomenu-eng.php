<?php $title="Inter Africa Travel - About Us" ?>
<!DOCTYPE html>
...
<div class="wrapper row3">
  <div id="container">
    <!-- ################################################################################################ -->
    <!-- InstanceBeginEditable name="EditRegion" -->    <section class="clear">
         <br/>
    <figure class="post-image"><img alt="" src="assets/images/demo/1200x400.gif"></figure>
     <h1 class="H1-shadow center">Cairo 4 Days / 3 Nights</h1>
     <br/>
      <h2>Trip Code:&nbsp;IFD-001</h2>
          <p>text text text text text text text text text text text text text text text text text text text text text text text text<a href="#" title="Free Website Templates">text text text text</a>text text text text text text text text text text text text <a href="#">text text text text text text text text</a>.</p>
<br/>
          <p>text text text text text text text text text text text text text text text text text text text text text text text text<a href="#" title="Free Website Templates">text text text text</a>text text text text text text text text text text text text <a href="#">text text text text text text text text</a>.</p>
                 <h1>Price:</h1>
           <h2>Special offer!</h2>
           <P><strong>This offer is valid from 1 Jnauary 2014 till 1 May 2014</strong></P>  
    </section>
<br/>
 <section>
      <h2>Ttile</h2>
