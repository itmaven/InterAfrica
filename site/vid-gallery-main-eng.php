    ...
    <div id="gallery" class="three_quarter">
        ...
        <figure>
          ...
          <ul class="clear center">
            <li class="one_third first"><a href="vid-gallery-intrnl-eng.php"><img src="assets/images/demo/gallery.gif" alt=""></a>
            <br/><a href="vid-gallery-intrnl-eng.php">text text text</a>
            </li>
            <li class="one_third"><a href="vid-gallery-intrnl-eng.php"><img src="assets/images/demo/gallery.gif" alt=""></a>
            <br/><a href="vid-gallery-intrnl-eng.php">text text text</a>
            </li>
            <li class="one_third"><a href="vid-gallery-intrnl-eng.php"><img src="assets/images/demo/gallery.gif" alt=""></a>
            <br/><a href="vid-gallery-intrnl-eng.php">text text text</a>
