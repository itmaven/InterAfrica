<?php $title="انتر افريكا - برامج الحج والعمرة"; ?>
<!DOCTYPE html>
      ...
      <ul class="clear">
        <li class="one_quarter first">
          <article class="clear boxes-intrnl">
            <figure class="post-image"><a href="internal-nomenu-ar.php"><img src="assets/images/tour-pic1.jpg" alt="القاهرة 4 أيام / 3 ليالي" title="القاهرة 4 أيام / 3 ليالي"></a></figure>
            <header style="text-align:center;">           
              <h2><strong><a href="internal-nomenu-ar.php">القاهرة 4 أيام / 3 ليالي</a></strong></h2>
            ...
            <footer class="read-more"><a href="internal-nomenu-ar.php">إقرأ المزيد &raquo;</a></footer>
          </article>
        </li>                
        ...
        <li class="one_quarter">
          <article class="clear boxes-intrnl">
            ...
            <footer class="read-more"><a href="internal-nomenu-ar.php">إقرأ المزيد &raquo;</a></footer>
                ...
                <li class="one_quarter">
          <article class="clear boxes-intrnl">
            <figure class="post-image"><a href="internal-nomenu-ar.php"><img src="assets/images/tour-pic1.jpg" alt="Cairo 3 days / 4 nights" title="Cairo 3 days / 4 nights"></a></figure>
            <header style="text-align:center;">
            
              <h2><strong><a href="internal-nomenu-ar.php">Cairo 3 days / 4 nights</a></strong></h2>
              <h2>Trip code: <strong>IFD-001</strong></h2>
              <h4>3 nights at Cairo movenpick resort including breakfast</h4>
              <h2><strong>Price: 3500 L.E</strong></h2>
              <h3><strong>(Special Offer)</strong></h3>
              <h6><strong> Vaild from 1 May 2014 to 1 June 2014</strong></h6>
                             </header>
            <footer class="read-more"><a href="internal-nomenu-ar.php">Read More &raquo;</a></footer>
          </article>
        </li>
                <li class="one_quarter">
          <article class="clear boxes-intrnl">
        ...
        <img src="assets/images/demo/1200x400.gif" alt="">
      </ul>
      <!-- ####################################################################################################### -->
      <nav class="pagination">
        <ul>
          <li class="prev"><a href="internal-nomenu-ar.php">&laquo; السابق</a></li>
          <li><a href="internal-nomenu-ar.php">1</a></li>
          <li><a href="internal-nomenu-ar.php">2</a></li>
          <li class="splitter"><strong>&hellip;</strong></li>
          <li><a href="internal-nomenu-ar.php">6</a></li>
          <li class="current"><strong>7</strong></li>
          <li><a href="internal-nomenu-ar.php">8</a></li>
          <li class="splitter"><strong>&hellip;</strong></li>
          <li><a href="internal-nomenu-ar.php">14</a></li>
          <li><a href="internal-nomenu-ar.php">15</a></li>
          <li class="next"><a href="internal-nomenu-ar.php">التالي &raquo;</a></li>
        </ul>
      </nav>
    </div>
