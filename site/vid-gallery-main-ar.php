<?php $title="Inter Africa Arabic Gallery"; ?>
<!DOCTYPE html>
...
<div class="wrapper row3">
  <div id="container">
    ...
    <br/>
    <div id="sidebar_1" class="sidebar one_quarter-gal">
        <aside>
        <!-- ########################################################################################## -->
        <h2>عنوان القائمة</h2>
<nav>
<ul id="sd-nav">
  ...
  <li><a href="#">أسوان</a>
    ...
    <div id="gallery" class="three_quarter first-gal">
      <section>
        <figure>
          <h2 class="H1-shadow center">عنوان الصفحة</h2>
          <br/>
          <ul class="clear center">
            <li class="one_third first"><a href="vid-gallery-intrnl-ar.php"><img src="assets/images/demo/gallery.gif" alt=""></a>
            <br/><a href="vid-gallery-intrnl-ar.php">نص نص نص</a>
            </li>
            <li class="one_third"><a href="vid-gallery-intrnl-ar.php"><img src="assets/images/demo/gallery.gif" alt=""></a>
            <br/><a href="vid-gallery-intrnl-ar.php">نص نص نص</a>
            </li>
            <li class="one_third"><a href="vid-gallery-intrnl-ar.php"><img src="assets/images/demo/gallery.gif" alt=""></a>
            <br/><a href="vid-gallery-intrnl-ar.php">نص نص نص</a>
      ...
      <nav class="pagination">
        <ul>
          <li class="prev"><a href="#">&laquo; السابق</a></li>
          <li><a href="#">1</a></li>
          <li><a href="#">2</a></li>
          ...
          <li><a href="#">14</a></li>
          <li><a href="#">15</a></li>
          <li class="next"><a href="#">التالي &raquo;</a></li>
        </ul>
      </nav>
    </div>
    <!-- ################################################################################################ -->
