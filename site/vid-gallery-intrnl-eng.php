<?php $title="Inter Africa Englsh Gallery"; ?>
<!DOCTYPE html>
  ...
  <div id="container">
    ...
    <br/>
        <div id="gallery">
         <section>
        <figure>
          <h2 class="H1-shadow center">video Gallery</h2>
        ...
        class="highslide"><img src="assets/images/demo/gallery.gif" alt="Gallery Image" title="Click to enlarge" /></a>
            <br/><a href="#">text text text</a>
            </li>
            
            <li class="one_third">            <a href="http://www.youtube.com/embed/a0qMe7Z3EYg?rel=0&amp;wmode=transparent" 
		onclick="return hs.htmlExpand(this, {objectType: 'iframe', width: 640, height: 480, 
		allowSizeReduction: false, wrapperClassName: 'draggable-header no-footer', 
		preserveContent: false, objectLoadTime: 'after'})"
        class="highslide"><img src="assets/images/demo/gallery.gif" alt="Gallery Image" title="Click to enlarge" /></a>
        ...
        class="highslide"><img src="assets/images/demo/gallery.gif" alt="Gallery Image" title="Click to enlarge" /></a>
            ...
            <li class="one_third first">            <a href="http://www.youtube.com/embed/a0qMe7Z3EYg?rel=0&amp;wmode=transparent" 
		onclick="return hs.htmlExpand(this, {objectType: 'iframe', width: 640, height: 480, 
		allowSizeReduction: false, wrapperClassName: 'draggable-header no-footer', 
		preserveContent: false, objectLoadTime: 'after'})"
        class="highslide"><img src="assets/images/demo/gallery.gif" alt="Gallery Image" title="Click to enlarge" /></a>
      ...
      <nav class="pagination">
        <ul>
          <li class="prev"><a href="phto-gallery-main-eng.php">&laquo; Back to Galery Main page</a></li>
        </ul>
      </nav>
      </div>
    <!-- ################################################################################################ -->
