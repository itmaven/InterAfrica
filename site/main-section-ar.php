      ...
      <section>
        <figure>
          ...
          <ul class="clear center">
            <li class="one_third first"><a href="internal-sidemenu-ar.php"><img src="assets/images/demo/gallery.gif" alt=""></a>
            <br/><a href="internal-sidemenu-ar.php">نص نص نص</a>
            </li>
            <li class="one_third"><a href="internal-sidemenu-ar.php"><img src="assets/images/demo/gallery.gif" alt=""></a>
            <br/><a href="internal-sidemenu-ar.php">نص نص نص</a>
            </li>
            <li class="one_third"><a href="internal-sidemenu-ar.php"><img src="assets/images/demo/gallery.gif" alt=""></a>
            <br/><a href="internal-sidemenu-ar.php">نص نص نص</a>
