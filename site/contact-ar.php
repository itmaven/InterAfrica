<?php $title="انتر افريكا للسياحة - اتصل بنا"; ?>
<!DOCTYPE html>
...
<div class="wrapper row3">
  <div id="container">
    ...
    <div id="contact" class="clear">
      ...
      <div class="one_half">
        <div class="map push50"><img src="assets/images/demo/map-sample.jpg" alt=""></div>
        <section class="contact_details clear">
          ...
          <div class="one_half">
            <ul class="list none">
              ...
              <li>Email: <a href="#">info@interafricaegypt.com</a></li>
            </ul>
          </div>
        </section>
      </div>
