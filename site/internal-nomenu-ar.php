<?php $title="انتر افركيا للسياحة - عن الشركة" ?> 
<!DOCTYPE html>
...
<div class="wrapper row3">
  <div id="container">
    ...
    <section class="clear">
    <br/>
      <h1 class="H1-shadow center">القاهرة 4 أيام / 3 ليالي</h1>
          <br/>
      <h2>كود الرحلة: &nbsp;IFD-001</h2>
...
<br/>
          <p>text text text text text text text text text text text text text text text text text text text text text text text text<a href="#" title="Free Website Templates">text text text text</a>text text text text text text text text text text text text <a href="#">text text text text text text text text</a>.</p>
           <h1>السعر :</h1>
           <h2>عرض خاص!</h2>
           <P><strong>العرض ساري من 1 يناير 2014 حتى 1 مايو 2014</strong></P>           
    </section>
<br/>
 <section>
      <h2>عنوان</h2>
