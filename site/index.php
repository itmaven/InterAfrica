...
<div class="wrapper row3">
  <div id="container">
    ...
    <div id="homepage" class="clear">
      <section class="main_slider" style="border:1px solid #CCCCCC;">	<!-- Start Banner BODY section -->
	<div id="Banner-container">
	<div class="ws_images"><ul>
<li><a href="#"><img src="assets/images/banner/1.jpg" alt="" title="" id="wows1_0"/></a></li>
<li><a href="#"><img src="assets/images/banner/2.jpg" alt="" title="" id="wows1_1"/></a></li>
<li><a href="#"><img src="assets/images/banner/3.jpg" alt="" title="" id="wows1_2"/></a></li>
</ul></div>
<div class="ws_bullets"><div>
<a href="#" title=""><img src="assets/images/banner/1-thumb.jpg" alt=""/>1</a>
<a href="#" title=""><img src="assets/images/banner/2-thumb.jpg" alt=""/>2</a>
<a href="#" title=""><img src="assets/images/banner/3-thumb.jpg" alt=""/>3</a>
</div></div>
	<div class="ws_shadow"></div>
	</div>
	<script type="text/javascript" src="assets/scripts/banner.js"></script>
	<script type="text/javascript" src="assets/scripts/script.js"></script>
	<!-- End Banner BODY section --></section>
      <!-- ################################################################################################ -->
      <section>
        <ul class="nospace clear">
          ...
          <li class="one_quarter  first">
            <article class="home-article">
              <div class="boxholder push30"><img src="assets/images/incoming-pc.jpg" alt=""></div>
              <h1>سياحة داخلية</h1>
              <p>نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص </p>
              <footer class="read-more"><a href="#">إقرأ المزيد &raquo;</a></footer>
            </article>
          </li>       
                  
                    <li class="one_quarter">
            <article class="home-article">
              <div class="boxholder push30"><img src="assets/images/outgoing-pc.jpg" alt=""></div>
              <h1>سياحة خارجية</h1>
              <p>نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص </p>
              <footer class="read-more"><a href="#">إقرأ المزيد &raquo;</a></footer>
            </article>
           ...
           <li class="one_quarter">
            <article class="home-article">
              <div class="boxholder push30"><img src="assets/images/haj&umrah-pc.jpg" alt=""></div>
              <h1>حج وعمرة</h1>
              <p>نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص </p>
              <footer class="read-more"><a href="#">إقرأ المزيد &raquo;</a></footer>
            </article>
 ...
 <li class="one_quarter">
            <article class="home-article">
              <div class="boxholder push30"><img src="assets/images/ticking-pc.jpg" alt=""></div>
              <h1>حجز تذاكر طيران</h1>
              <p>نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص </p>
              <footer class="read-more"><a href="#">إقرأ المزيد &raquo;</a></footer>
            </article>
          </li>
      ...
      <section class="last clear">
          ...
          <h2>معلومات تهمك</h2>
          <div class="boxholder2"><img src="assets/images/tour-tips.jpg" alt=""></div>
          </br>
              <p>نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص </p>
              <footer class="read-more"><a href="#">إقرأ المزيد &raquo;</a></footer>
        </article>
        ...
        <div class="one_half">
          ...
          <ul class="nospace spacing clear">
            <li class="one_half first" style="direction:rtl;">
              <figure class="clear">
                <div class="imgl boxholder"><img src="assets/images/demo/80x80.gif" alt=""></div>
                <figcaption>نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص نص.
              <footer class="read-more"><a href="#">إقرأ المزيد &raquo;</a></footer>
                </figcaption>
              </figure>
            </li>
